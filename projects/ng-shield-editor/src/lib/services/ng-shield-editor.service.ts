  ...
  public generateSVG(settings: NgShieldSettings): string {
    ...
    return `
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        ...
        <!-- Motivo -->
        <!-- style="fill: ${settings.color2}" clip-path="url(#bg${settings.shape})" -->
            
        <path style="fill: ${settings.color2}" clip-path="url(#bg${settings.shape})" d=" M 225.00 0.00 L 285.00 0.00 C 285.00 170.67 285.00 341.33 285.00 512.00 L 225.00 512.00 C 225.00 341.33 225.00 170.67 225.00 0.00 Z" />
